...
optimal_alpha = dynamics.basic_hamilton_calc.calc_simple_optimal_parameters(r0, total_alpha_min, 0.9 * m0 / t_burn,
                                                                            t_burn)
...
thruster_properties = {'throat_diameter': 2,
                       ...
                       'file_name': file_name}
dynamics.set_engine_properties(thruster_properties, propellant_properties)
...
x_states, time_series, thr = dynamics.run_simulation(x0, xf, time_options)
