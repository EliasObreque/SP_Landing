...
class PSO:
    ...
    def plot_historical_position(self, folder, name):
    ...
    def plot_best_cost(self, folder, name):
        fig = plt.figure()
    ...
    def plot_result(self, folder="", name=""):
        self.plot_historical_position(folder, name)
        self.plot_best_cost(folder, name)
...
class PSOStandard(PSO):
    ...
    def optimize(self):
        ...
        while iteration < self.max_iteration:
            ...
            iteration += 1
        print("Finished")
        return self.historical_g_position[-1], min_state[0]
